...
<div>
   <li className=" py-5 ">
   <h1 onClick={() => handleNavigateToPage("Installation")} className="font-bold">Learn Abot Nextjs</h1>
...
<div>
   <li className="border-spacing-x-14 py-5">
   <h1 onClick={() => handleNavigateToPage("Installation")} className="font-bold">How To Install Next.js</h1>
   <p>Install Node.js. Follow one of the links to install according to your system, Windows or Linux. Step 2: Now create a folder for your project on the desktop and navigate to the folder.</p>
   </li>
</div>

<div>
    <li className=" py-5">
    <h1 onClick={() => handleNavigateToPage("ReacttoNetjs")} className="font-bold">Reactjs To Nextjs</h1>
